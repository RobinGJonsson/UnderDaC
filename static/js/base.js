// Auto scroll down to the form section if user wants to update booking
let pageURL = window.location.href;

if (pageURL.includes('update_booking')) {
  document.querySelector('#form-section').scrollIntoView(alignToTop = true);
}
